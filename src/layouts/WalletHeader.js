...
import nounBell from '../assets/nounBell.svg';
import mainStyle from './WalletLayout.less';
import styles from './WalletHeader.less';
        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.headerMenu}>
            ...
            >
              ...
              <Menu.Item key="/dashboard/buy">Buy</Menu.Item>
              <Menu.Item key="/dashboard/sell">Sell</Menu.Item>
              <Menu.Item key="_" disabled style={{ cursor: 'default' }}>
                |
              </Menu.Item>
              <Menu.Item key="/wallets">Wallets</Menu.Item>
            </Menu>
          </div>
          <div className={styles.headerUser}>
            ...
            <Divider type="vertical" style={{ color: '#fff', marginBottom: 3, height: 15 }} />
            <img
              src={nounBell}
              alt="warn"
              style={{ color: '#fff', marginBottom: 3, marginLeft: 10 }}
            />
            <Link to="/">
              <span>Onur Tekin</span>
            </Link>
          </div>
        </div>
      </div>
