    ...
    >
      ...
      <div style={{ position: 'relative', margin: 60, paddingTop: 90, display: 'flex', flex: 1 }}>
        ...
        <div style={{ display: 'flex', flex: 5, flexDirection: 'column' }}>
          <div style={{ flex: 1 }}>
            <h2>
              You are <b>sending 0.23397 BTC </b> ≈£937.46{' '}
            </h2>
          </div>

          <div style={{ flex: 1 }}>
            Enter verification code just sent to you with SMS.
            <br />
            <div style={{ marginTop: 15 }}>
              <Input
                placeholder="Basic usage"
                style={{ width: 80, float: 'left', marginRight: 10 }}
              />
              <p style={{ paddingTop: 6 }}>
                Didn’t receive? We can <a>send it again.</a>
              </p>
            </div>
          </div>
          <div style={{ flex: 1 }}>
        ...
        <div style={{ display: 'flex', flex: 5 }}>asdfasdfasd</div>
      </div>
    </Modal>
  );
};
